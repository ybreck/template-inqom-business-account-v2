...
const FinancingTablePage: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-white shadow-xl rounded-lg max-w-5xl mx-auto">
      <h2 className="text-2xl sm:text-3xl font-semibold text-theme-text mb-6 text-center">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.map((row, index) => (
              <tr 
                key={index} 
                className={`
                  ${row.isHeader ? 'bg-theme-primary-50' : ''}
              ...
              >
                <td className={`px-4 sm:px-6 py-3 whitespace-nowrap text-sm 
                  ...
                  ${row.isHeader ? 'text-theme-primary-700' : 'text-theme-text'}
                ...
                <td className={`px-4 sm:px-6 py-3 whitespace-nowrap text-sm text-right 
                  ...
                  ${row.isGrandTotal ? 'text-lg text-theme-primary-700' : 'text-theme-text'}
                  ${row.className || ''}
                `}>
