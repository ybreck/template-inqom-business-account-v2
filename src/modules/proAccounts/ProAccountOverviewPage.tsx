            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {activeCards.slice(0, 2).map(card => (
                  <div key={card.id} className="border border-slate-200 rounded-xl overflow-hidden hover:border-slate-300 transition-colors flex flex-col">
                    {/* Visual Card */}
                    <div className="p-5 bg-[#222325] text-white relative h-48 shrink-0">
                      <div className="absolute top-5 left-5">
                        <h4 className="text-sm font-medium text-slate-100">{card.cardholderName}</h4>
                      </div>
                      
                      <div className="absolute top-4 right-5">
                        <span className="text-xl font-bold tracking-tight text-white">swan</span>
                      </div>
                      
                      <div className="absolute bottom-5 right-5 flex">
                        <div className="w-6 h-6 rounded-full bg-[#EB001B] opacity-90 z-10 mix-blend-multiply"></div>
                        <div className="w-6 h-6 rounded-full bg-[#F79E1B] opacity-90 -ml-2 z-0 mix-blend-multiply"></div>
                      </div>

                      <div className="absolute top-1/2 left-5 right-5 -translate-y-1/2 mt-2">
                        <p className="text-lg font-mono tracking-widest text-white">
                          1234 12•• •••• {card.last4Digits}
                        </p>
                      </div>

                      <div className="absolute bottom-5 left-5 flex items-center gap-4 text-xs text-slate-300 font-mono">
                        <p>{card.expiryDate}</p>
                        <p>CVC •••</p>
                      </div>
                    </div>
